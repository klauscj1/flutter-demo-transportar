...
class Slideshow extends StatelessWidget {
  final List<TarjetaModel> slides;
...
class TarjetaModel {
  ...
  final String texto;
  final bool fin;
  TarjetaModel({@required this.svg, @required this.texto, @required this.fin});
}
